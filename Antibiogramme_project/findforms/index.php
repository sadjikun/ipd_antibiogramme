...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="plugins/modal.js"></script>
...
<form id="bacterioform" method="POST" style="font-weight: normal;width:91%" class="div_table_style_class" >
    ...
    <table style="width:95%;border-spacing: 7px;">
        <tr>
            <td>
                <label for="num_etiquette" id="label_num_etiquette">Numéro d'étiquette</label>
            ...
            <td>
                <label for="id_patient" id="label_id_patient">ID Patient</label>
                <label style="color:red;">(*)</label>:
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="javascript:void(0);" 
                    class="class_button_clear" onclick="$('#date_reception_lab').val('');">
    ...
    <table  id="" style="width:95%;border-spacing: 7px; text-align: center;">  
        <tr>
            <td>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1" style="border-radius: 25px;"> button 1 </button>
            </td>
            <td>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2"> button 2 </button>
            </td>					  										
        </tr>
    </table>
    <!-- Modal 1 -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- info_patient_germe START -->
                    <table class="ipg" style="display:none; width:95%; border-spacing: 7px;" id="second">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" 
                                    class="class_button_clear" onclick="$('#date_reception_ipg').val('');">
                                    <img src="images/clear.png" class="class_clear_img" />
                                </a>
...
<!-- END INITIAL STUFF -->
    ...
    <br>
    <br>
    <input type="submit" id="sbt_info_mal_bacterio"  value="Enregistrer les informations" class="myButton" style="padding:13px;"/>    
</form>
...
<table  id="" style="width:95%;border-spacing: 7px;">
	...
	<tr>
		...
		<td>
            ...
            <a href="javascript:void(0);" 
                class="class_button_clear" onclick="$('#date_rendu_resultat').val('');">
                <img src="images/clear.png" class="class_clear_img" />
            </a>
...
<table class="info_autres_virus_respiratoires" style="display:none; width:95%; border-spacing: 7px;" >
    <tr> <td> <label style="font-weight:bold;font-size:16px;text-align: center;">Info autres virus respiratoires:</label></td> </tr>
    <tr>
...
<tr> <td> <label style="font-weight:bold;font-size:16px;text-align: center;">Info influenza A:</label></td> </tr>
<tr>
...
<table class="info_influenza_B" style="display:none; width:95%; border-spacing: 7px;" >
    <tr> <td> <label style="font-weight:bold;font-size:16px;text-align: center;">Info influenza B:</label></td> </tr>
    <tr>
...
<table  id="" style="width:95%;border-spacing: 7px;">
	...
	<tr>
		...
		<td>
            ...
            <a href="javascript:void(0);" 
                class="class_button_clear" onclick="$('#date_reception_lab_arbo').val('');">
                <img src="images/clear.png" class="class_clear_img" />
            </a>
    ...
    <tr>
		...
		<td>
            ...
            <a href="javascript:void(0);" 
                class="class_button_clear" onclick="$('#date_expedition_resultat').val('');">
                <img src="images/clear.png" class="class_clear_img" />
            </a>      
        </td>					
	</tr>
...
<table  id="" style="width:95%;border-spacing: 7px;">  
    <tr>
		...
		<td>
            ...
            <a href="javascript:void(0);" 
                class="class_button_clear" onclick="$('#date_envoi_sero').val('');">
                <img src="images/clear.png" class="class_clear_img" />
            </a>      
        </td>					
	</tr>
...
<table  id="" style="width:95%;border-spacing: 7px;">  
    <tr>
		...
		<td>
            ...
            <a href="javascript:void(0);" 
                class="class_button_clear" onclick="$('#date_envoi_seroneutra').val('');">
                <img src="images/clear.png" class="class_clear_img" />
            </a>      
        </td>					
	</tr>
...
<table  id="" style="width:95%;border-spacing: 7px;"> 
    <tr>
		...
		<td>
            ...
            <a href="javascript:void(0);" 
                class="class_button_clear" onclick="$('#date_envoi_biomol').val('');">
                <img src="images/clear.png" class="class_clear_img" />
            </a>      
        </td>					
	</tr>
...
<table  id="" style="width:95%;border-spacing: 7px;"> 
    ...
    <tr>				
		...
		<td class="resultat_recherche_genome_viral" > <input type="text" id="resultat_recherche_genome_venregistiral" name="resultat_recherche_genome_viral" class="inputs2"/>  </td>																			
    </tr>
